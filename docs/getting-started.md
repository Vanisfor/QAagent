...
cp .env.example .env.development
# Fill in: DEEPSEEK_API_KEY, JWT_SECRET_KEY, POSTGRES_* (point to your DB)
...
**Tracing files**
Local traces are written under `logs/traces`; set `TRACING_ENABLED=false` to disable them.
