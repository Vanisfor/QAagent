...
ingest:
	@if [ -z "$(DOC)" ]; then \
		echo "Usage: make ingest DOC=\"path/to/docs\""; exit 1; \
	fi
	@$(call run_with_env,uv run python scripts/ingest_docs.py '$(DOC)')
...
help:
	...
	@echo ""
	@echo "Knowledge base:"
	@echo "  ingest DOC=path      Ingest documents into the RAG knowledge base"
	@echo ""
	@echo "Evaluation:"
